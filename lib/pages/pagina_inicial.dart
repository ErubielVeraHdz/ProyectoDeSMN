...
class _PaginaInicialState extends State<PaginaInicial> {
  ...
  void _cargarFavoritos() async {
    ...
    setState(() {
      ciudadesFavoritas = favoritos.map((c) => c.label).toList();
    });
  }
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    if (resultado != null &&
                        resultado is Map<String, String> &&
                        mounted) {
                      final providerMunicipio = Provider.of<ProviderMunicipio>(
                          context,
                          listen: false);
                      providerMunicipio.setCiudad(
                        context,
                        nombre: resultado['label']!,
                        IdEdo: resultado['idEdo']!,
                        IdMpo: resultado['idMpo']!,
                      );
                    }
                  },
                ),
        ...
        children: <Widget>[
          ...
          Consumer<ProviderPronosticos>(
            ...
            if (proveedor_de_dias.pronosticos.isEmpty) {
              return Center(child: Text("No hay pronósticos disponibles"));
            }
